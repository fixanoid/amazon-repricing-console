	...
	ajaxSave: function(bgDb) {
		...
		var payload = {
			...
			"viewContext": {
				...
				"searchText":"",
				"filters":[{"filterGroupId":"LISTINGS_VIEW","filterCriteria":[{"value":"true","filterId":"Catalog"}]},{"filterGroupId":"FULFILLMENT","filterCriteria":[{"value":"true","filterId":"AllChannels"}]}],
				"clientState": {
			...
			if (f) {
				$.ajax({
					...
					error: function(data, textStatus, errorThrown) {
						debug('[inventory.ajaxSave] remote error');
