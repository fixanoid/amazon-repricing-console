...
ol = {
			...
			function(request) {
				if (request.action == 'exclusionList') {
					...
					if (request.buckets.indexOf('item') >= 0 ) {
						// need items bucket
						var asin = document.location.href.replace('https://www.amazon.com/gp/offer-listing/', '').replace('https://www.amazon.co.uk/gp/offer-listing/', '');
	...
	process: function() {
		var i, j, el, p, s, c, seller, f, lowest, cond, excluded = 0,
		 asin = document.location.href.replace('https://www.amazon.com/gp/offer-listing/', '').replace('https://www.amazon.co.uk/gp/offer-listing/', '');
