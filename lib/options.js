...
document.addEventListener('DOMContentLoaded', function () {
	...
	document.getElementById('bucketFeatured').addEventListener('change', function () { saveCheckbox('bucketFeatured'); });
	document.getElementById('bucketNew').addEventListener('change', function () { saveCheckbox('bucketNew'); });
	document.getElementById('bucketUsed').addEventListener('change', function () { saveCheckbox('bucketUsed'); });
	document.getElementById('bucketItem').addEventListener('change', function () { saveCheckbox('bucketItem'); });
});
